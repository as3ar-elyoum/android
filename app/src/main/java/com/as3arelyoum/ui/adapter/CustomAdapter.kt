...
import com.as3arelyoum.databinding.RecyclerviewItemsBinding
import com.bumptech.glide.Glide
import com.bumptech.glide.load.engine.DiskCacheStrategy

class CustomAdapter(
    var context: Context,
    private var list: List<ItemsModel>
    ...
    inner class CustomViewHolder(val binding: RecyclerviewItemsBinding) :
